...
const DeliveryFooter = () => {
    ...
    return (
        <footer className="relative bg-gray-900 overflow-hidden">
            ...
            <div className="text-gray-400 px-6 pt-16 pb-0 relative z-10">
                <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-12 gap-y-12 gap-x-8 pb-12 border-b border-white/5">
                    <div className="col-span-2 lg:col-span-8">
                        <Link to="/delivery/dashboard" className="flex items-center gap-2.5 mb-6 group">
                            <img src={logo} alt="Logo" className="w-8 h-8 object-contain hover:scale-110 transition-transform duration-300" />
                            <span className="text-2xl font-extrabold text-white tracking-tight">
                                Chatori<span className="text-orange-500">App</span> <span className="text-sm font-medium text-gray-500">Delivery Portal</span>
                            </span>
                        </Link>
                        <p className="text-[15px] leading-relaxed mb-8 text-gray-400 font-medium max-w-lg">
                            Dedicated portal for our delivery partners. Manage your tasks, track your earnings, and stay connected with the fleet.
                        </p>
                    ...
                    <div className="col-span-2 lg:col-span-4">
                        <h4 className="text-[13px] font-bold uppercase tracking-[0.15em] text-white mb-7">Contact Support</h4>
                        <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/5 space-y-5">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <span className="text-[14px] font-medium leading-normal pt-1 break-all">support@chatoriapp.com</span>
                            </div>
                        </div>
                    </div>
                </div>
