...
export const CartProvider = ({ children }) => {
    ...
    const reorder = async (items) => {
        ...
        setLoading(true);
        try {
            const { data } = await api.post('/cart/reorder', { items });
            setCart(data);
        } finally { setLoading(false); }
    };
    ...
    return (
        <CartContext.Provider value={{ cart, addToCart, updateQuantity, removeItem, clearCart, reorder, cartTotal, cartCount, loading, fetchCart }}>
            {children}
