...
import { FiCheckCircle, FiArrowRight, FiPackage, FiHome } from 'react-icons/fi';
...
const PaymentSuccess = () => {
    return (
        <div className="min-h-screen pt-24 bg-gray-50 dark:bg-gray-950 px-4 pb-20 relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-green-100 dark:bg-green-900/10 rounded-full blur-[120px] pointer-events-none -mr-64 -mt-64"></div>
            ...
            <div className="max-w-xl w-full relative z-10">
                <header className="mb-10 text-center">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-24 h-24 bg-green-500/10 rounded-[2rem] text-green-500 mb-8 border border-green-500/20 shadow-2xl shadow-green-500/10"
                    >
                    ...
                    >
                        Order <span className="text-green-500 underline decoration-green-200 dark:decoration-green-900/50 decoration-8 underline-offset-8">Confirmed</span>
                    </motion.h1>
                </header>
                ...
                >
                    <p className="text-gray-600 dark:text-gray-400 font-bold text-base mb-10 leading-relaxed">
                        Thank you for choosing <span className="text-orange-500">ChatoriApp</span>! We've received your payment and our chefs have started working their magic. You'll receive a notification as soon as your food is out for delivery.
                    </p>
